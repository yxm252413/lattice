package com.lattice.latticegoods.aspect;

import com.lattice.latticecommon.aspect.BaseAspect;
...
public  class GoodsAspect{
	@Autowired
	private static Logger logger = LoggerFactory.getLogger(GoodsAspect.class);
